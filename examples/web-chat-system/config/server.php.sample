...
return [
    ...
    'file_logger' => [
        Logger::DEBUG     => __DIR__ . '/../logs/server_debug.log',
        Logger::INFO      => __DIR__ . '/../logs/server_info.log',
        Logger::NOTICE    => __DIR__ . '/../logs/server_notice.log',
        Logger::WARNING   => __DIR__ . '/../logs/server_warning.log',
        Logger::ERROR     => __DIR__ . '/../logs/server_error.log',
        Logger::CRITICAL  => __DIR__ . '/../logs/server_critical.log',
        Logger::ALERT     => __DIR__ . '/../logs/server_alter.log',
        Logger::EMERGENCY => __DIR__ . '/../logs/server_emergency.log',
    ]
];