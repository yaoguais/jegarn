(function(window){
    ...
    jegarn.packet = (function(){
        ...
        packet.Base = (function(){
            ...
            base.prototype.getSubType = function(){
                return this.content['type'] != "undefined" ? this.content['type'] : null;
            };
            return base;
        })();
        ...
        packet.Chat = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.Base, []);
                s.type = packet.Chat.TYPE;
            };
        })();
        packet.Chat.TYPE = 'chat';

        packet.GroupChat = (function(){
            var groupchat = function(){
                var s = this;
                jegarn.extends(s, packet.Base, []);
                s.type = packet.GroupChat.TYPE;
        ...
        packet.GroupChat.TYPE = 'groupchat';
        ...
        packet.Chatroom = (function(){
            var chatroom = function(){
                ...
                jegarn.extends(s, packet.Base, []);
                s.to = 'all';
                s.type = packet.Chatroom.TYPE;
                s.content = {group_id : null};
            };
            //noinspection JSUnusedGlobalSymbols
            chatroom.prototype.isSendToAll = function(){
                return 'all' == this.to;
            };
            chatroom.prototype.setSendToAll = function(){
                this.to = 'all';
            };
        ...
        packet.Chatroom.TYPE = 'chatroom';

        packet.TextChat = (function(){
            var text = function(){
                var s = this;
                jegarn.extends(s, packet.Chat, []);
                s.content = {type: packet.TextChat.SUB_TYPE, text : null};
            };
        ...
        packet.TextChat.SUB_TYPE = 'text';

        packet.TextGroupChat = (function(){
            var text = function(){
                var s = this;
                jegarn.extends(s, packet.GroupChat, []);
                s.content = {type: packet.TextGroupChat.SUB_TYPE, text : null};
            };
            text.prototype.getText = function(){
                return this.content.text;
            };
        ...
        packet.TextGroupChat.SUB_TYPE = 'text';

        packet.TextChatroom = (function(){
            var text = function(){
                var s = this;
                jegarn.extends(s, packet.Chatroom, []);
                s.content = {type: packet.TextChatroom.SUB_TYPE, text : null};
            };
            text.prototype.getText = function(){
                return this.content.text;
            };
        ...
        packet.TextChatroom.SUB_TYPE = 'text';

        packet.Notification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.Base, []);
                s.type = packet.Notification.TYPE;
            };
        })();
        packet.Notification.TYPE = 'notification';

        packet.UserNotification = (function(){
            var p = function(){
                var s = this;
                jegarn.extends(s, packet.Notification, []);
                s.content = {uid: null};
            };
            p.prototype.setUserId = function(uid){
        ...
        packet.FriendNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.UserNotification, []);
            };
        })();

        packet.FriendRequestNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.FriendNotification, []);
                s.content.type = packet.FriendRequestNotification.SUB_TYPE;
            };
        })();
        packet.FriendRequestNotification.SUB_TYPE = 'friend_request';

        packet.FriendAgreeNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.FriendNotification, []);
                s.content.type = packet.FriendAgreeNotification.SUB_TYPE;
            };
        })();
        packet.FriendAgreeNotification.SUB_TYPE = 'friend_agree';

        packet.FriendRefusedNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.FriendNotification, []);
                s.content.type = packet.FriendRefusedNotification.SUB_TYPE;
            };
        })();
        packet.FriendRefusedNotification.SUB_TYPE = 'friend_refused';

        packet.GroupNotification = (function(){
            var group = function(){
                var s = this;
                jegarn.extends(s, packet.UserNotification, []);
            };
            ...
            group.prototype.setGroupId = function(id){
                this.content.group_id = id;
            };
            group.prototype.getGroupName = function(){
                return this.content.group_name;
            };
        ...
        packet.GroupRequestNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.GroupNotification, []);
                s.content.type = packet.GroupRequestNotification.SUB_TYPE;
            };
        })();
        packet.GroupRequestNotification.SUB_TYPE = 'group_request';

        packet.GroupAgreeNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.GroupNotification, []);
                s.content.type = packet.GroupAgreeNotification.SUB_TYPE;
            };
        })();
        packet.GroupAgreeNotification.SUB_TYPE = 'group_agree';

        packet.GroupRefusedNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.GroupNotification, []);
                s.content.type = packet.GroupRefusedNotification.SUB_TYPE;
            };
        })();
        packet.GroupRefusedNotification.SUB_TYPE = 'group_refused';

        packet.GroupInvitedNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.GroupNotification, []);
                s.content.type = packet.GroupInvitedNotification.SUB_TYPE;
            };
        })();
        packet.GroupInvitedNotification.SUB_TYPE = 'group_invited';

        packet.GroupDisbandNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.GroupNotification, []);
                s.content.type = packet.GroupDisbandNotification.SUB_TYPE;
            };
        })();
        packet.GroupDisbandNotification.SUB_TYPE = 'group_disband';

        packet.GroupQuitNotification = (function(){
            return function(){
                var s = this;
                jegarn.extends(s, packet.GroupNotification, []);
                s.content.type = packet.GroupQuitNotification.SUB_TYPE;
            };
        })();
        packet.GroupQuitNotification.SUB_TYPE = 'group_quit';
    ...
    jegarn.client.prototype = {
        ...
        send: function(content){
            ...
            return this.ws.send(content) || true;
        },
